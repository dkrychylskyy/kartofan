kartofan.controller('mapActivityCtrl', function mapActivityCtrl(NgMap, $modal, $popover, $scope) {
    ...
    */
    ...
    /* Marques */
    vm.markers = {};
    function Restauant(position, titre, type, img, prix, delaiLivraison, menu) {
   ...
   vm.markers.marker1 = new Restauant([43.65095096, 1.38046211], "HolaPizza","p", "../img/rest1.jpg", 10, 15);
   vm.markers.marker2 = new Restauant([43.63758, 1.38399315], "Le Carrelet","r", "../img/rest2.jpg", 20, 18);
   vm.markers.marker3 = new Restauant([43.64565009, 1.40561622], "La Faim des Haricots","p", "../img/rest3.jpg", 16, 14);
   vm.markers.marker4 = new Restauant([43.64232286, 1.36425325], "La Faim des Haricots","r", "../img/rest4.jpg", 13, 8, [1,2,3,4,5]);
